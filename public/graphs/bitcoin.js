...
$.getJSON('/data/bitcoin?callback=?', function (data) {
  ...
  Highcharts.theme = {
    ...
    rangeSelector: {
      buttonTheme: {
        ...
        style: { color: '#CCC' },
        states: {
          hover: { fill: '#4c5b71', stroke: '#000000', style: { color: 'white' } },
    ...
    navigator: {
      ...
      series: { color: '#ecc007', lineColor: '#A6C7ED' },
  ...
  Highcharts.stockChart('container', {
    ...
    title: { text: 'Bitcoin Current Data' },
    xAxis: { gapGridLineWidth: 0 },
    series: [{ name: 'Bitcoin', data: series.data, tooltip: { valueDecimals: 2 } }]
  });
});
