...
function RoyalCountdown() {
	...
	****************************/
	...
	this.isDynamicColor = false, 			//Back color will vary(true or false)
	...
	function TimerEnd() {
		...
		canvasContext.font = 60*param.elementSize+"px Roboto Condensed";
	...
	function AllImages() {
		...
		this.colons = function() {
			...
			canvasContext.font = 64*param.elementSize+"px Roboto Condensed";
			canvasContext.textAlign = "center";
			canvasContext.save();
	...
	function DrawText() {
		canvasContext.fillStyle = textColor;
		canvasContext.font = 26*param.elementSize+"px Roboto Condensed";
		canvasContext.textAlign = "center";
